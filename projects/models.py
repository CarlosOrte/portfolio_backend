...
class Project(models.Model): # <-- Clase cambiada a Project
    ...
    main_image = models.ImageField(upload_to='project_images/', blank=True, null=True, verbose_name="Imagen Principal del Proyecto") # <-- Carpeta de subida cambiada y etiqueta
